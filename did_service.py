...
def create_talk(text: str, language: str = "Hebrew") -> str:
    voice_id = VOICE_BY_LANGUAGE.get(language, "he-IL-HilaNeural")
    payload = {
...
def wait_for_talk(talk_id: str, timeout: int = 120, poll_interval: float = 3.0) -> str:
